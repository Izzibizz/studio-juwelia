...
export function TestimonialsSection({
  ...
  return (
    <section className="p-6  pb-20 laptop:pb-[220px] bg-lightBrown relative">
      <div
        className={`flex flex-col ${!isEditing ? "laptop:flex-row" : ""} w-11/12 mx-auto gap-6`}
      >
      ...
      >
        <path
          d="M0,0c111.85,102.35,276.86,111.96,421.45,90.29,77.89-11.68,161.89-31.97,235.55-59.84v79.05H0V0Z"
          fill="#e4ddd3"
        />
      </svg>
    </section>
